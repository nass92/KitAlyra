import { Button, Box, Container, Heading, Text, Flex, Badge, Center } from "@chakra-ui/react"
...
const Pricing = () => {
  ...
  return (
    <Box as="section" id="pricing" bg="#f6f3f3" maxW="container.8xl" p="10">
      <Container maxW="container.md">
        ...
        <Box alignItems="center" d={["block", "null", "flex"]}>
          <Box bg="white" shadow="lg" flex="1" zIndex="1" mb={[6, 6, 0]}>
            <Center pt="6"> <Badge>Standard</Badge> </Center>
            <Center> <Text as="b" fontSize="6xl">{price} $</Text> /month </Center>
          ...
          <Box bg="white" shadow="lg" flex="1">
            <Center pt="6"> <Badge>Entreprise</Badge> </Center>
            ...
            <Button isFullWidth={true} colorScheme="teal" borderRadius="none" size="lg">Contact us</Button>
          </Box>
        </Box>
      </Container>
    </Box >
